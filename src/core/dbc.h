...
#define F_R2(dbc, exp, a, b) if(!(exp)) { mempko::muda::util::raise2( __FILE__, __FUNCTION__, __LINE__, dbc, F_STR(exp), F_STR(a), a, F_STR(b), b); } 
#define F_R3(dbc, exp, a, b, c) if(!(exp)) { mempko::muda::util::raise3( __FILE__, __FUNCTION__, __LINE__, dbc, F_STR(exp), F_STR(a), a, F_STR(b), b, F_STR(c), c); } 
